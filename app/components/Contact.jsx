        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between">
            <div className="bg-[#f8fafc] p-10 rounded-[2.5rem] border border-slate-100 shadow-sm h-full flex flex-col">
              <h3 className="text-3xl font-Condensed Sans-Serif text-slate-800 mb-8 uppercase tracking-wider">Contact Us</h3>
              ...
              <div className="space-y-8 flex-grow">
                {contactInfo.map((item, idx) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest mb-1">{item.title}</p>
                      <p className="text-slate-600 text-sm leading-relaxed font-medium">{item.details}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            >
              ...
              <div className="absolute top-8 right-8">
                <a 
                  ...
                  target="_blank"
                  className="bg-[#022c22] text-white px-8 py-4 rounded-2xl flex items-center gap-3 text-xs font-bold shadow-2xl hover:bg-emerald-600 transition-all"
                >
              ...
              <div className="absolute bottom-8 right-8 bg-white/90 backdrop-blur-md px-8 py-4 rounded-3xl border border-white/20 shadow-lg flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-white font-bold">NC</div>
                <div>
                  <p className="text-[10px] font-bold text-emerald-600 tracking-widest uppercase">Visit Us At</p>
                  <p className="text-xs font-bold text-slate-800">NATURE CITY CLUBHOUSE</p>
                </div>
              </div>
            </motion.div>
          </div>
