...
const images = [
  ...
  "/assets/images/nature-city-img/WhatsApp Image 2026-01-28 at 6.36.15 PM.jpeg",
  ...
  "/assets/images/slider/WhatsApp Image 2026-01-29 at 11.13.00 AM (2).jpeg",
];
    ...
    <section className="bg-white py-15 px-4">
      <div className="max-w-9xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-7xl font-semibold font-Condensed Sans-Serif text-emerald-900 mb-4">
            Take a look around <span className="text-emerald-600">The Plots</span>
          </h2>
